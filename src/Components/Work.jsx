...
const projectsData = [
  ...
  {
  name: "EduConnect",
  description: "RESTful API for an e-learning platform with course management, enrollment system, and role-based access control.",
  image: "/apii.png",
  link: "https://github.com/housna11/EduConnect",
  technologies: ["Laravel", "MySQL"]
  }
];
